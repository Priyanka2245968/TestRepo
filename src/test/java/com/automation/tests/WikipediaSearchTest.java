...
public class WikipediaSearchTest extends BaseTestManager {
    ...
    public void testWikipediaSearch() throws Exception {
        ...
        pageObject.waitForTimeout(2000); // wait for article page
        
        pageObject.expandSection("History");
        pageObject.takeScreenshot("wikipedia-test-" + System.currentTimeMillis() + ".png");
