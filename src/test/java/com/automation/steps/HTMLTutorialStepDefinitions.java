...
public class HTMLTutorialStepDefinitions {
    ...
    @Then("the HTML Tutorial heading should be visible")
    public void theHTMLTutorialHeadingShouldBeVisible() throws Exception {
        pageObject.verifyHTMLTutorialHeadingVisible();
    }

    @Then("the HTML HOME navigation should be highlighted")
    public void theHTMLHOMENavigationShouldBeHighlighted() throws Exception {
