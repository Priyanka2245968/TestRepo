...
public class HTMLTutorialStepDefinitions {
    ...
    @Then("the HTML Tutorial heading should be displayed")
    public void theHTMLTutorialHeadingShouldBeDisplayed() throws Exception {
        pageObject.verifyHTMLTutorialHeadingDisplayed();
    }

    @Then("the HTML HOME link should be highlighted in the left navigation")
    public void theHTMLHomeLinkShouldBeHighlightedInTheLeftNavigation() throws Exception {
