...
public class HTMLTutorialStepDefinitions {
    ...
    public void executeStep5(String description) throws Exception {
        System.out.println("📍 Step 5: " + description);
        pageObject.step5();
    }

    @When("I execute step 6: {string}")
    public void executeStep6(String description) throws Exception {
        System.out.println("📍 Step 6: " + description);
        pageObject.step6();
    }

    @When("I execute step 7: {string}")
    public void executeStep7(String description) throws Exception {
        System.out.println("📍 Step 7: " + description);
        pageObject.step7();
    }
