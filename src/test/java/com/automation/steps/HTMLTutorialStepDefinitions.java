...
public class HTMLTutorialStepDefinitions {
    ...
    @Then("the HTML Tutorial page loads at {string}")
    public void theHTMLTutorialPageLoadsAt(String url) throws Exception {
    ...
    public void thePageHeadingIsDisplayedInTheMainContentArea(String heading) throws Exception {
        pageObject.verifyHTMLTutorialHeadingVisible();
    }
    
    @Then("the left navigation panel shows {string} highlighted under the HTML section")
    public void theLeftNavigationPanelShowsHighlightedUnderTheHTMLSection(String navItem) throws Exception {
        pageObject.verifyHTMLHomeNavigationHighlighted();
    }
