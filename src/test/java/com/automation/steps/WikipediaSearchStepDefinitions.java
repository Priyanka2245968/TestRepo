...
public class WikipediaSearchStepDefinitions {
    ...
    @When("I expand the {string} section in the left panel")
    public void iExpandTheSectionInTheLeftPanel(String sectionName) throws Exception {
        pageObject.expandSection(sectionName);
    }
