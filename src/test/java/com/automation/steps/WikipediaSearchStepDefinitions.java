...
public class WikipediaSearchStepDefinitions {
    ...
    public void iEnterInTheSearchBox(String query) throws Exception {
        System.out.println("📍 Entering '" + query + "' in the search box");
    ...
    public void iPressEnterToSubmitTheSearch() throws Exception {
        System.out.println("📍 Pressing Enter to submit the search");
        pageObject.pressEnterToSearch();
    }
    
    @When("I click on the first search result titled {string}")
    public void iClickOnTheFirstSearchResultTitled(String resultTitle) throws Exception {
        System.out.println("📍 Clicking on the first search result titled '" + resultTitle + "'");
        pageObject.clickSearchResult(resultTitle);
    }
