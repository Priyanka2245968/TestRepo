...
public class WikipediaSearchStepDefinitions {
    ...
    @Then("the search results page should show {string}")
    public void theSearchResultsPageShouldShow(String text) throws Exception {
    ...
    @Then("the Wikipedia article page for HTML should load with content visible")
    public void theWikipediaArticlePageForHTMLShouldLoadWithContentVisible() throws Exception {
