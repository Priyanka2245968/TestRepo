...
public class WikipediaSearchStepDefinitions {
    ...
    public void iClickTheFirstLinkInSearchResults(String linkText) throws Exception {
        pageObject.clickFirstResultLink(linkText);
    }
    
    @When("I expand the {string} section in the table of contents")
    public void iExpandTheSectionInTheTableOfContents(String sectionName) throws Exception {
        if (sectionName.equals("History")) {
