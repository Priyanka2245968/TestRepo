...
public class WikipediaSearchStepDefinitions {
    ...
    public void searchResultsShouldShow(String text) throws Exception {
    ...
    @Then("the Wikipedia article content should be visible")
    public void theWikipediaArticleContentShouldBeVisible() throws Exception {
