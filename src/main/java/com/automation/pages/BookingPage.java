...
public class BookingPage {
    ...
    public void invalidBookingMissingField() {
        System.out.println("📍 Creating a booking with missing required field");
        Map<String, Object> body = new HashMap<>();
        body.put("lastname", "Roy");
        body.put("totalprice", 12000);
        body.put("depositpaid", true);
    ...
    public void invalidBookingInvalidDates() {
        System.out.println("📍 Creating a booking with checkout date before check-in date");
        Map<String, Object> body = new HashMap<>();
        body.put("firstname", "Swarup");
        body.put("lastname", "Roy");
        body.put("totalprice", 12000);
    ...
    public void takeScreenshot(String filename) {
        testManager.getPage().screenshot(new com.microsoft.playwright.options.ScreenshotOptions().setPath(filename + ".png"));
    }
}