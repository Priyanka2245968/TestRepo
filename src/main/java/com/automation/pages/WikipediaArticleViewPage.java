...
public class WikipediaArticleViewPage {
    ...
    public void clickFirstArticleLink(String title) throws Exception {
        System.out.println("📍 Click the first '" + title + "' link in search results");
        page.locator("a[href='/w/index.php?title=" + title + "&redirect=no']").first().click();
        page.waitForTimeout(3000); // wait for navigation after click
    }
