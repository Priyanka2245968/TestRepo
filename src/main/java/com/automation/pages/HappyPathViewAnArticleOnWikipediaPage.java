...
public class HappyPathViewAnArticleOnWikipediaPage {
    ...
    public boolean verify_Photosynthesis_is_a_process_used_by_plants_and_other_organisms_to_convert_light_energy_into_chemical_energy() {
        // Article page contains description of photosynthesis
        return driver.findElement(By.cssSelector("Photosynthesis is a process used by plants and other organisms to convert light energy into chemical energy")).isDisplayed();
    }
}