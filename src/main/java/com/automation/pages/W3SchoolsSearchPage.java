...
public class W3SchoolsSearchPage {
    ...
    public void verifySearchResults() {
        ...
        page.locator(".search-results-container").first().waitFor(new Locator.WaitForOptions().setTimeout(10000));
    }

    public void verifyHTMLTutorials() {
        System.out.println("📍 Results should contain HTML-related tutorials");
        page.locator("text=HTML Tutorials").first().waitFor(new Locator.WaitForOptions().setTimeout(10000));
    }
