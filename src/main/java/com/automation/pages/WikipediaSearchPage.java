...
public class WikipediaSearchPage {
    ...
    public void clickFirstResultLink(String linkText) throws Exception {
        System.out.println("📍 Click the first '" + linkText + "' link in search results");
        page.locator("a:has-text('" + linkText + "')").first().click();
    }
    
    public void expandHistorySection() throws Exception {
        System.out.println("📍 Expand the 'History' section in the table of contents");
        // expand 'History'
    }
